...
void validateDate() {
    ...
    if (mm == 1 || mm == 3 || mm == 5 || mm == 7 || mm == 8 || mm == 10 || mm == 12) {
        if (dd < 1 || dd > 31) isValid = 0;
    } else if (mm == 4 || mm == 6 || mm == 9 || mm == 11) {
        if (dd < 1 || dd > 30) isValid = 0;
    } else if (mm == 2) {
        int leap = 0;
        if ((yy % 4 == 0 && yy % 100 != 0) || (yy % 400 == 0)) leap = 1;
        if ((dd < 1) || (dd > 29) || (dd == 29 && !leap)) isValid = 0;
    }
...
```
# Output:
<img width="1918" height="1017" alt="image" src="https://github.com/user-attachments/assets/7891f629-24ec-49cf-bf0d-8238b7600087" />
...
```
# Output:
<img width="1918" height="1023" alt="image" src="https://github.com/user-attachments/assets/2cd2d66e-0c8c-47fa-8bf3-873adb4d2d2f" />
...
```
# Output:
<img width="1918" height="1021" alt="image" src="https://github.com/user-attachments/assets/dd17d030-faec-4553-b98f-d32d93a7b868" />
...
```
# Output:
<img width="1918" height="1022" alt="image" src="https://github.com/user-attachments/assets/867107a9-aab8-4e9b-bc98-f82a92535f62" />
...
```
# Output:
<img width="1918" height="1018" alt="image" src="https://github.com/user-attachments/assets/9968acc4-96b9-4ea3-89ad-0ef956d85e1d" />
